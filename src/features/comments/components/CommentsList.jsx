...
import { useComments } from '../api/getComments.js';

import { DeleteComment } from './DeleteComment.jsx';

/** @typedef {{ discussionId: string }} CommentsListProps */

/** @param {CommentsListProps} props */
  ...
  return (
    <ul aria-label="comments" className="flex flex-col space-y-3">
      {commentsQuery.data.map((comment, index) => (
        ...
        >
          <Authorization policyCheck={POLICIES['comment:delete'](/** @type {User} */(user), comment)}>
