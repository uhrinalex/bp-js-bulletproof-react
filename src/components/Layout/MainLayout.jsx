...
import { useAuthorization, ROLES } from '@/lib/authorization.jsx';

/**
 * @typedef {Object} SideNavigationItem
 * @property {string} name
 * @property {string} to
 * @property {((props: React.SVGProps<SVGSVGElement>) => JSX.Element)} icon
 */
...
/**
 * @typedef {Object} UserNavigationItem
 * @property {string} name
 * @property {string} to
...
const UserNavigation = () => {
  ...
  const userNavigation = /** @type {UserNavigationItem[]} */[
...
/**
 * @typedef {Object} MobileSidebarProps
 * @property {boolean} sidebarOpen
 * @property {React.Dispatch<React.SetStateAction<boolean>>} setSidebarOpen
 */

/** @param {MobileSidebarProps} props */
